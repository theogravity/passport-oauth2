 ...
 * @api protected
 */
OAuth2Strategy.prototype.userProfile = function(accessToken, done, tokenReqResults, req) {
  return done(null, {});
};
 ...
 * @api private
 */
OAuth2Strategy.prototype._loadUserProfile = function(accessToken, done, tokenReqResults, req) {
  var self = this;

  function loadIt() {
    return self.userProfile(accessToken, done, tokenReqResults, req);
  }
  function skipIt() {
    return done(null);
  }

 ...
 * @api protected
 */
OAuth2Strategy.prototype.userProfile = function(accessToken, done, tokenReqResults) {
  return done(null, {});
};
 ...
 * @api private
 */
OAuth2Strategy.prototype._loadUserProfile = function(accessToken, done, tokenReqResults) {
  var self = this;

  function loadIt() {
    return self.userProfile(accessToken, done, tokenReqResults);
  }
  function skipIt() {
    return done(null);
  }
